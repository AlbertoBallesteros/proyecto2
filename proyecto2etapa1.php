    ...
    <table border=1px>
        ...
        <tr>
            <td>
                ...
                $contador = 0;
                /*Recorro todas las líneas de fichero con el while, en la variable $tareas creo una lista dividiendo cada línea por ; el primer elemento que sería [0] es para el id
